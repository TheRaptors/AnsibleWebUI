...
class Job(CommonModel):
    ...
    def start(self, **kwargs):
        from Ansible.tasks import RunJob, BuildJob
        if self.status != 'new':
            return False
...
#     created_by = models.DateTimeField(null=False, blank=False)
#
#
# class webansible(models.Model):
#
#     inventory = models.TextField(null=False, blank=False)
#
#     sudo = models.BooleanField(default=True)
#
#     args = models.TextField(null=False, blank=False)
#
#     module = models.CharField(choices=TYPE_MODULE,max_length=64)
#
